    ...
    return (
        <section className="max-w-6xl mx-auto px-5 md:px-0 my-20 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-6 z-10 relative">
                <div className="md:col-span-2 text-white relative rounded-xl text-center h-[25rem] md:h-full bg-[#41a46d] p-10 md:p-16 overflow-hidden flex flex-col justify-center">
                ...
                <div className="md:col-span-4 border group cursor-pointer bg-white rounded-xl overflow-hidden">
                    ...
                    <div className="p-16 bg-[#41a46d1f] border group-hover:border-none group-hover:bg-[#41a46d]  ease-in duration-300">
                ...
                <div className="md:col-span-2 group border cursor-pointer bg-white rounded-xl overflow-hidden">
                    ...
                    <div className="p-11 bg-[#41a46d1f] border group-hover:border-none group-hover:bg-[#41a46d]  ease-in duration-300">
                ...
                <div className="md:col-span-2 border group cursor-pointer bg-white rounded-xl overflow-hidden">
                    ...
                    <div className="p-11 border group-hover:border-none bg-[#41a46d1f] group-hover:bg-[#41a46d]  ease-in duration-300">
