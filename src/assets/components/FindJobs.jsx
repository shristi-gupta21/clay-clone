    ...
    return (
        <section className="max-w-6xl mx-auto px-5 md:px-0 py-10 md:py-20 relative">
            ...
            <div className="grid  grid-cols-1 md:grid-cols-6 gap-6 z-10 relative">
                <div className="md:col-span-2 h-[25rem] md:h-full text-white relative rounded-xl bg-[#cc3c58] p-10 md:p-16 text-center md:text-start overflow-hidden flex flex-col justify-center">
                ...
                <div className="md:col-span-4 border group cursor-pointer bg-white rounded-xl overflow-hidden">
                    ...
                    <div className="p-16 bg-[#cc3c581f] border group-hover:border-none group-hover:bg-[#cc3c58]  ease-in duration-300">
                ...
                <div className="md:col-span-2 group border cursor-pointer bg-white rounded-xl overflow-hidden">
                    ...
                    <div className="p-11 bg-[#cc3c581f] border  group-hover:border-none group-hover:bg-[#cc3c58]  ease-in duration-300">
                ...
                <div className="md:col-span-2 border group cursor-pointer bg-white rounded-xl overflow-hidden">
                    ...
                    <div className="p-11 border  group-hover:border-none bg-[#cc3c581f] group-hover:bg-[#cc3c58]  ease-in duration-300">
