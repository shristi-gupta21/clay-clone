...
export const TrustedTeams = () => {
    return (
        <section className="max-w-7xl mx-auto md:px-0 px-5 flex flex-col items-center md:items-start">
            <div className="flex gap-1">
                <h2 className=" font-semibold">Trusted by 20,000+ leading teams</h2>
                <img src={window.location.origin + "/images/down-arrow.svg"} />
            </div>
            <div className="w-full flex md:flex-col flex-row gap-x-12 md:gap-x-16 justify-center md:justify-start mt-6 gap-y-4">
